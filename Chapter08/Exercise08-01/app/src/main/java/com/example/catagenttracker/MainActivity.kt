...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val catStretchingRequest = OneTimeWorkRequestBuilder<CatLitterBoxSittingWorker>()
        ...
        val catLitterBoxSittingRequest = OneTimeWorkRequestBuilder<CatLitterBoxSittingWorker>()
            .setConstraints(networkConstraints)
            .setInputData(
                workDataOf(
        ...
        val catSuitUpRequest = OneTimeWorkRequestBuilder<CatSuitUpWorker>()
            .setConstraints(networkConstraints)
            .setInputData(
                workDataOf(
                    CatSuitUpWorker
