...
fun SettingsImage(modifier: Modifier = Modifier) {
    Row(
        ...
        Text(
            text = stringResource(
                R.string.settings_profile_image
            ),
            fontSize = 18.sp
        )
        Image(
            modifier = Modifier
                ...
                .height(34.dp)
                .clickable {
                    // TODO: Handle changing the profile image
                },
            painter = painterResource(
                R.drawable.android_picture
            ),
            contentDescription = stringResource(
                R.string.settings_profile_image
            )
...
@Composable
fun SettingsCheckBox(modifier: Modifier = Modifier) {
